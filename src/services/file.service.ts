...
const getExtension = (filename: string, defaultExtension = "") => {
...
export const saveCoverArtFromBlob = (songId: string, coverArtBlob?: Blob, originalCoverArtFilename?: string): SaveReturn => {
	if (coverArtBlob) {
