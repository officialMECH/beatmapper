...
export const convertObstaclesToRedux = (obstacles, gridCols = DEFAULT_NUM_COLS) => {
...
export const convertObstaclesToExportableJson = (obstacles, gridCols = DEFAULT_NUM_COLS) => {
...
export const createObstacleFromMouseEvent = (mode, numCols, numRows, colWidth, rowHeight, mouseDownAt, mouseOverAt, beatDuration = 4) => {
