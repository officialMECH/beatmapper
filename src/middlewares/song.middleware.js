	...
	return (store) => (next) => async (action) => {
		switch (action.type) {
			...
			case "SCROLL_THROUGH_SONG": {
				...
				let newCursorPosition = direction === "forwards" ? state.navigation.cursorPosition + incrementInMs : state.navigation.cursorPosition - incrementInMs;
			...
			case "SKIP_TO_END": {
				...
				const lastBeatInSong = Math.floor(convertMillisecondsToBeats(state.navigation.duration, song.bpm));
