...
![Google Images search](/src/docs/images/google-image-search.png)
...
![A search on Unsplash.com](/src/docs/images/unsplash.png "Unsplash has many beautiful images")
...
![New song modal](/src/docs/images/new-song-modal.png)
