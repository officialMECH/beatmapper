...
However, my hope is that this rewrite can serve as a nice groundwork for other contributors who would like to implement new features and workflows,
or even opening up new possibilities for community members to repurpose the editor for other potential use cases. 😉

## Credits

Beatmapper was originally a side-project made by Josh Comeau for fun. If you derive value from it, feel free to show your support to the original author:
