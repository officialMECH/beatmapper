...
![](/src/docs/images/download-from-github.gif "If you happen to already know Git, then you should probably fork and clone instead.")
...
![](/src/docs/images/mac-terminal.png)

On Windows 10, it's called "Command prompt". It looks slightly different:

![](/src/docs/images/windows-terminal.png)
...
![](/src/docs/images/beatmapper-contents.png)
...
![](/src/docs/images/built-output.png)
