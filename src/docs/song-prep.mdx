...
![](/src/docs/images/audacity-intro.png "This guide was written using MacOS, but the instructions should be the same for any OS")

To save the file as `.ogg`, you can choose `File -> Export -> Export as OGG`:

![](/src/docs/images/audacity-export.png)
...
![](/src/docs/images/only-now-intro.png)
...
![](/src/docs/images/only-now-zoomed.png)
...
![](/src/docs/images/beatport-bpm.jpg "'BPM' is highlighted under the waveform")
...
![](/src/docs/images/wonderwall-bpm.png)
...
![](/src/docs/images/only-now-zoomed-out.png)
...
![](/src/docs/images/bad-computer-waveform.png)
...
![](/src/docs/images/bad-computer-waveform-annotated.png)
...
![](/src/docs/images/bad-computer-waveform-tweaked.png)
