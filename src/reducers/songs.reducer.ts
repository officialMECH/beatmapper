...
export const getSelectedSongDifficultyIds = createSelector(getSelectedSong, (selectedSong: any) => {
	/**
...
export const getEnabledMods = createSelector(getSelectedSong, (song): EnabledMods => {
	return {
...
export const getEnabledFastWalls = createSelector(getSelectedSong, (song) => {
	return song.enabledFastWalls;
});
export const getEnabledLightshow = createSelector(getSelectedSong, (song) => {
	return song.enabledLightshow;
});

export const getCustomColors = createSelector(getSelectedSong, (song) => {
