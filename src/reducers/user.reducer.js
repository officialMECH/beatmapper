...
export const getProcessingDelay = (state) => (typeof state.user.processingDelay === "number" ? state.user.processingDelay : DEFAULT_PROCESSING_DELAY);
...
export const getGraphicsLevel = (state) => (typeof state.user.graphicsLevel === "string" ? state.user.graphicsLevel : DEFAULT_GRAPHICS_LEVEL);
