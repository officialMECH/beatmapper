...
export const roundToNearest = (number, nearest) => Math.round(number / nearest) * nearest;

export const roundAwayFloatingPointNonsense = (n) => roundToNearest(n, 1 / 1000000);

export const floorToNearest = (number, nearest) => Math.floor(number / nearest) * nearest;
...
const getIsMac = (platform = navigator.platform) => !!navigator.platform.match(/^Mac/);
