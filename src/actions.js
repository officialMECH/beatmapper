...
export const createNewSong = (coverArtFilename, coverArtFile, songFilename, songFile, songId, name, subName, artistName, bpm, offset, selectedDifficulty) => (dispatch, getState) => {
...
export const clickPlacementGrid = (rowIndex, colIndex) => (dispatch, getState) => {
	const state = getState();
...
export const setBlockByDragging = (direction, rowIndex, colIndex, selectedTool) => (dispatch, getState) => {
	const state = getState();
...
export const drawSelectionBox = (selectionBox, selectionBoxInBeats) => (dispatch, getState) => {
	const state = getState();
