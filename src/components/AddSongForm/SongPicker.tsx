				...
				return (
					<MediaWrapper>
						{loadingWaveformData ? (
							...
							// HACK: I'm reusing the same 'scrubbableWaveform' from the editor. A better solution would be to extract a shared "Waveform" base component, and build 2 variants on top of it.
							// TODO: Would be cool if this actually was scrubbable, and playable!
							<ScrubbableWaveform width={500} height={height - UNIT * 2} waveformData={waveformData} duration={waveformData ? waveformData.duration : null} cursorPosition={0} scrubWaveform={() => {} /* noop */} />
						)}
					</MediaWrapper>
				);
			}}
