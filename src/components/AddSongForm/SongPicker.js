				...
				return (
					<MediaWrapper>
						{loadingWaveformData ? (
							...
							// and playable!
							<ScrubbableWaveform width={500} height={height - UNIT * 2} waveformData={waveformData} duration={waveformData.duration} cursorPosition={waveformData.duration} scrubWaveform={() => {} /* noop */} />
						)}
					</MediaWrapper>
				);
			}}
