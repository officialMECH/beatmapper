...
const Lighting = () => {
	...
	return (
		<>
			...
			<directionalLight castShadow intensity={0.6} position={[0, 30, SONG_OFFSET]} target={frontLightTarget} angle={0.5} penumbra={1} />
			<directionalLight intensity={0.25} position={[0, 0, 20]} angle={1} penumbra={1} />

			<directionalLight intensity={0.5} position={[50, 50, SONG_OFFSET - 30]} target={midLightTarget} angle={1} penumbra={1} />
			<directionalLight intensity={0.5} position={[-50, 50, SONG_OFFSET - 30]} target={midLightTarget} angle={1} penumbra={1} />
