...
const GridSquare = ({ rowIndex, colIndex, numRows, numCols, rowHeight, colWidth, isHovered, gridPosition, mouseDownAt, setMouseDownAt, setMouseOverAt, mappingMode, defaultObstacleDuration, selectionMode, selectedTool, setHoveredCell, clickPlacementGrid, createNewObstacle }) => {
	...
	return (
		...
		>
			...
			<meshBasicMaterial attach="material" color={0xffffff} transparent={true} opacity={isHovered ? 0.2 : 0.1} side={THREE.DoubleSide} />
		</mesh>
	);
};
